...
class CallService {
  ...
  String get localVideoStreamId =>
      _activeCall!.localVideoStream?.streamId ?? '';
  late String remoteVideoStreamId;

  CallState get callState => _callState;
  late CallState _callState;

  VIEndpoint? get endpoint => _endpoint;
  late VIEndpoint? _endpoint;

  late Function onIncomingCall;
  ...
  void _onLocalVideoStreamRemoved(VICall call, VIVideoStream videoStream) {
    if (call.callId == _activeCall!.callId) {
      ...
      _activeStreamController.add(OnChangedLocalVideoCallEvent(streamId: ''));
    }
  }
  ...
  void _onRemoteVideoStreamRemoved(
    ...
    remoteVideoStreamId = '';
    _activeStreamController.add(OnChangedRemoteVideoCallEvent(streamId: ''));
  }
